...
public class Reader_Writer_Problem_Solve_Using_ReentrantLock_Part2 {
	
	public static void main(String[] args) {
		
		SharedBufferResource sharedResource = new SharedBufferResource();
